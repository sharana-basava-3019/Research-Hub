...
/**
 * @swagger
 * /api/collaborations/{id}/revoke:
 *   put:
 *     summary: Revoke collaboration invitation or remove accepted collaborator
 *     tags: [Collaborations]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Collaboration revoked / collaborator removed
 */
router.put('/:id/revoke', revokeCollaboration);
router.put('/:id/exit', exitCollaboration);
