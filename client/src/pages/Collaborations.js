...
const Collaborations = () => {
  ...
  return (
    <div className="container section">
      ...
      {/* Stats Summary - Capsule Style */}
      <div className="row g-3 mb-4">
        <div className="col-6 col-md-3">
          <div 
            className="badge rounded-pill bg-primary text-white w-100 px-3 py-3 d-flex flex-column flex-md-row align-items-center justify-content-center gap-2"
            style={{ cursor: 'pointer', fontSize: '0.9rem' }}
            onClick={() => handleStatClick('pending')}
          >
            <span className="fw-bold fs-4">{collaborations.filter(c => c.status === 'Pending').length}</span>
            <span>Pending</span>
          </div>
        </div>
        <div className="col-6 col-md-3">
          <div 
            className="badge rounded-pill bg-success text-white w-100 px-3 py-3 d-flex flex-column flex-md-row align-items-center justify-content-center gap-2"
            style={{ cursor: 'pointer', fontSize: '0.9rem' }}
            onClick={() => handleStatClick('accepted')}
          >
            <span className="fw-bold fs-4">{collaborations.filter(c => c.status === 'Accepted').length}</span>
            <span>Accepted</span>
          </div>
        </div>
        <div className="col-6 col-md-3">
          <div 
            className="badge rounded-pill bg-danger text-white w-100 px-3 py-3 d-flex flex-column flex-md-row align-items-center justify-content-center gap-2"
            style={{ cursor: 'pointer', fontSize: '0.9rem' }}
            onClick={() => handleStatClick('rejected')}
          >
            <span className="fw-bold fs-4">{collaborations.filter(c => c.status === 'Rejected').length}</span>
            <span>Rejected</span>
          </div>
        </div>
        <div className="col-6 col-md-3">
          <div 
            className="badge rounded-pill bg-info text-white w-100 px-3 py-3 d-flex flex-column flex-md-row align-items-center justify-content-center gap-2"
            style={{ cursor: 'pointer', fontSize: '0.9rem' }}
            onClick={() => handleStatClick('total')}
          >
            <span className="fw-bold fs-4">{collaborations.length}</span>
            <span>Total</span>
          </div>
        </div>
      </div>
