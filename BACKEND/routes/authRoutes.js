 ...
 *   get:
 *     summary: Search users by username, first name, last name, full name, or email
 *     tags: [Authentication]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /api/auth/active-researchers:
 *   get:
 *     summary: Get public list of active researchers for platform showcases
 *     tags: [Authentication]
 *     responses:
 *       200:
 *         description: List of active researchers
 */
router.get('/active-researchers', getActiveResearchers);
 ...
 *   put:
 *     summary: Update own email address (requires password confirmation)
 *     tags: [Authentication]
 *     security:
 *       - bearerAuth: []
 *     responses:
